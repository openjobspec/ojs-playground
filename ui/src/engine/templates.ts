...
export const JOB_TEMPLATES: JobTemplate[] = [
  ...
  },
  {
    ...
    spec: {
      ...
      queue: 'reports',
      args: ['analytics'],
      meta: { recipients: ['notifications@example.com'], format: 'pdf' },
  ...
  // Cron / Scheduling
  {
    ...
    description: 'Recurring daily report generation using cron scheduling',
    category: 'data',
    level: 2,
    spec: {
      specversion: '1.0.0-rc.1',
      ...
      meta: { recipients: ['notifications@example.com'], format: 'pdf' },
      timeout: 600,
      cron: { expression: '0 6 * * *', timezone: 'America/New_York' },
      retry: { max_attempts: 3, initial_interval: 'PT30S', backoff_coefficient: 2.0, max_interval: 'PT10M' },
    },
  },
  {
    id: 'cron-cache-warmup',
    title: 'Cron: Cache Warmup',
    description: 'Periodic cache warmup every 15 minutes',
    category: 'infrastructure',
    level: 2,
    spec: {
      specversion: '1.0.0-rc.1',
  ...
  // Batch workflow
  {
    ...
    description: 'Process batch of invoices with completion callback',
    category: 'workflows',
    level: 3,
    spec: {
      specversion: '1.0.0-rc.1',
      ...
      meta: {
        workflow_type: 'batch',
        steps: ['invoice.validate', 'invoice.process_a', 'invoice.process_b', 'invoice.process_c', 'invoice.finalize'],
      },
      timeout: 3600,
      retry: { max_attempts: 3, initial_interval: 'PT5S', backoff_coefficient: 2.0, max_interval: 'PT5M' },
    },
